 ...
 *
 * Edited to be portrait-locked by unidscanner.unid.capstone.com (Worthday) team
 */
...
public class CameraSourcePreview extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // Swap width and height sizes if in landscape proportions (lock tp portrait)
        // for some reason it is counterintuitive (width < height = landscape)
